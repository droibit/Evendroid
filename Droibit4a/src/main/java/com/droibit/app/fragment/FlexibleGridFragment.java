 ...
 */
public abstract class FlexibleGridFragment extends Fragment {
    ...
    public FlexibleGridFragment() {
    }
    
    protected abstract GridView createGridView(Context context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GridView gv = createGridView(getActivity());
