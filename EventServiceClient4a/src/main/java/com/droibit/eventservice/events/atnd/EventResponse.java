...
public class EventResponse implements IMappable {
	...
	/** シリアルID */
	private static final long serialVersionUID = -3639649451720776550L;
	...
	public static class Event implements IMappable {
		...
		/** シリアルID */
		private static final long serialVersionUID = 3828646947758357725L;
		...
		public String ownerTwitterId;

		/** 主催者のTwitter 画像 */
		@SerializedName("owner_twitter_img")
		public String ownerTwitterImage;
